...
interface SpinnerLoaderBaseProps {}
interface SpinnerLoaderProps
  extends
    SpinnerLoaderBaseProps,
    /* @vue-ignore */
    SVGAttributes {}

const SpinnerLoader = defineComponent<SpinnerLoaderProps>({
  name: "SpinnerLoader",
  setup(_, { attrs }) {
    return () => (
      <svg
      ...
      >
        ...
        <path
          ...
          class="stark-loader-spinner-outer"
        />
        <path
...
export type { SpinnerLoaderBaseProps, SpinnerLoaderProps }
